...
.titlepage .titlebox{border:1px solid #333;padding:1.6em 1em;width:auto;min-width:80%;max-width:94%;min-height:70%;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center}
.titlepage .title{font-size:1.4em;font-weight:600;margin:0 0 0.5em 0;line-height:1.5;word-break:keep-all;overflow-wrap:anywhere}
